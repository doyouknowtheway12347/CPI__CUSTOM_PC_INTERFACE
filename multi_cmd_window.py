class Output:
    ...
    def print_all_data(self, smart_wrap=False):
        # Adjust column width based on total width and number of channels
        column_width = (self.total_width // self.no_channels) - 2  # Adjust to fit partition
        wrapped_data = []
...
output.add_data(4, "Just a simple line.")
